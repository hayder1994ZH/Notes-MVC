...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" placeholder="fuul name ..." autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="new-account">
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-danger login-btn"> <?php echo e(__('Go To Login')); ?></a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH E:\GitHub-Projects\Arrow\resources\views/auth/register.blade.php ENDPATH**/ ?>